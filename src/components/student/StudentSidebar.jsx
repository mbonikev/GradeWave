...
function StudentSidebar({ closeSidebar, showSidebar }) {
  ...
  return (
    <div
      className={`${
        showSidebar ? "w-[255px] min-w-[255px] max-sm:w-full" : "max-lg:w-0"
      } transition-all z-40 bg-body-bg h-svh sticky top-0 left-0 max-lg:fixed flex flex-col bg-lightSidebarBg text-lightBlackText border-r border-stone-100 overflow-y-auto`}
    >
