...
function StudentSidebar({ closeSidebar, showSidebar }) {
  ...
  return (
    <div
      ...
      } transition-all duration-300 z-10 bg-body-bg h-svh sticky top-0 left-0 max-lg:fixed flex flex-col bg-lightSidebarBg text-lightBlackText border-r border-stone-100 overflow-y-auto`}
    >
