  ...
  return (
    <div className="w-full bg-body-bg py-5">
      <div className="w-full max-w-4xl mx-auto rounded-3xl h-[250px] bg-main-color overflow-hidden relative">
        <h1 className="backdrop-blur-md text-white font-extrabold tracking-tight text-4xl w-fit h-fit p-5 rounded-3xl shadow-lg absolute top-0 left-0 bottom-0 right-0 m-auto">GradeWave</h1>
