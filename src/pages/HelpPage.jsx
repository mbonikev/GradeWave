    ...
    <div className="min-h-screen bg-card-bg-weak py-10 px-6">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="space-y-6">
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-3">1. How to Mark Exams</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-3">2. Viewing Student Results</h2>
            <p className="text-gray-700">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-3">3. Exam Scheduling</h2>
            <p className="text-gray-700">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-3">4. User Management</h2>
            <p className="text-gray-700">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-3">5. Technical Support</h2>
            <p className="text-gray-700">
