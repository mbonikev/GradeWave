        ...
        <form className="w-full flex-1 py-[100px] flex flex-col items-start justify-center max-w-[400px] mx-auto">
          ...
          {role === "student" ? (
            ...
            <>
              ...
              <button className={`${role === "student" ? 'bg-main-color' : ''} hover:bg-main-color-dark text-white select-none text-base font-semibold px-3 py-2.5 w-full flex items-center justify-center gap-2 mt-5 rounded-2xl`}>
                Continue
              </button>
            </>
          )}
