    ...
    <div className="w-full h-fit overflow-y-auto flex-1 flex">
      ...
      >
        ...
        <div className="w-full h-fit max-w-[1120px] px-2.5 max-lg:px-5 min-h-[1000px] mx-auto">
          ...
          <div className="w-full mt-10 lg:max-w-[550px] mx-auto ">
            <div className="w-full  h-fit  bg-stone-200/60 p-1 rounded-2xl mt-6">
            ...
            {role === 1 ? (
              <>
                <h1 className="text-base font-normal opacity-80 mt-6 mb-3">
                  Enter the Index Number <span className="text-red-500">*</span>
                </h1>
                <input
                  // disabled={!isAgree}
                  // onClick={() => login()}
