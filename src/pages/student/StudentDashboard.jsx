          ...
          <div className="w-full grid grid-cols-2 max-md:grid-cols-1">
            ...
            <div className="w-full">
              <div className="w-full ring-1 ring-card-bg-weak shadow-sm rounded-2xl p-4 font-medium tracking-tight mt-16 text-text-color/80 flex items-start gap-1 justify-start flex-col border-b">
                ...
                <h1><span className="text-2xl font-medium ">#<strong className="pl-0.5">3</strong></span><span className="text-text-color-weak/80 font-normal"> from 2,342 Students</span></h1>
              </div>
