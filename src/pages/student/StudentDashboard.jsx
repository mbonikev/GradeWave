  ...
  return (
    <div className="w-full min-h-svh flex-1 flex">
      ...
      <div
        className={`${
          showSidebar && ""
        } max-lg:transition-all max-lg:duration-200 max-lg:ease-in-out w-fit max-lg:w-full flex-1 h-svh flex flex-col z-10 bg-sidebar-bg overflow-y-auto relative`}
      >
        {showSidebar && (
          <div
