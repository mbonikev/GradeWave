    ...
    <div className="w-full min-h-svh overflow-y-auto flex-1 flex">
      ...
      >
        ...
        <div className="w-full h-fit max-w-[1120px] px-2.5 max-lg:px-5 min-h-[1000px] mx-auto">
          ...
          <div className="w-full max-w-[340px] mt-3 rounded-2xl ring-1 ring-card-bg-weak shadow-sm p-3 flex items-center">
            <div className="flex flex-col text-sm ">
              <h1 className="text-base font-medium mb-2 text-text-color/80">National Examination 2025</h1>
